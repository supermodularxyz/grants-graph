...
export type RoundDetailsQueryResult = (
  { __typename?: 'Query' }
  & { round?: Maybe<(
    { __typename?: 'Round' }
    & Pick<Round, 'id'>
    & { roundMetaPtr: (
      ...
      & { votes?: Maybe<Array<(
        { __typename?: 'QFVote' }
        & Pick<QfVote, 'projectId' | 'from' | 'id' | 'amount' | 'to' | 'token'>
      )>> }
    ), projects?: Maybe<Array<(
      { __typename?: 'RoundProject' }
      & Pick<RoundProject, 'project' | 'payoutAddress'>
      & { metaPtr: (
        { __typename?: 'MetaPtr' }
        & Pick<MetaPtr, 'id' | 'pointer' | 'protocol'>
      ) }
    )>> }
  )> }
);
...
/**
 * __useRoundDetailsQuery__
 *
 * To run a query within a React component, call `useRoundDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useRoundDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useRoundDetailsQuery(baseOptions: Apollo.QueryHookOptions<RoundDetailsQueryResult, RoundDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RoundDetailsQueryResult, RoundDetailsQueryVariables>(RoundDetailsDocument, options);
      }
export function useRoundDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RoundDetailsQueryResult, RoundDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RoundDetailsQueryResult, RoundDetailsQueryVariables>(RoundDetailsDocument, options);
        }
export type RoundDetailsQueryHookResult = ReturnType<typeof useRoundDetailsQuery>;
export type RoundDetailsLazyQueryHookResult = ReturnType<typeof useRoundDetailsLazyQuery>;